    ...
    regions: [
      {
        ...
        avoid: [1, 2, 12],
        months: [
          { mean: -4, rain: 3 }, { mean: 0, rain: 5 }, { mean: 6, rain: 8 },
          { mean: 14, rain: 20 }, { mean: 21, rain: 35 }, { mean: 26, rain: 75 },
          { mean: 27, rain: 170 }, { mean: 25, rain: 140 }, { mean: 21, rain: 50 },
          { mean: 13, rain: 25 }, { mean: 4, rain: 10 }, { mean: -2, rain: 2 },
        ],
      },
      {
        ...
        months: [
          ...
          { mean: 28, rain: 230 }, { mean: 28, rain: 230 }, { mean: 27, rain: 170 },
          { mean: 24, rain: 80 }, { mean: 20, rain: 40 }, { mean: 15, rain: 25 },
        ],
      },
      {
        ...
        avoid: [12, 1, 2],
        months: [
          { mean: -5, rain: 1 }, { mean: -1, rain: 1 }, { mean: 2, rain: 2 },
          { mean: 6, rain: 5 }, { mean: 11, rain: 25 }, { mean: 15, rain: 70 },
          { mean: 15, rain: 120 }, { mean: 14, rain: 120 }, { mean: 12, rain: 65 },
          { mean: 7, rain: 10 }, { mean: -1, rain: 2 }, { mean: -3, rain: 1 },
        ],
      },
    ],
  },
